      ...
      >
        ...
        >
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline" style="line-height:40px">{{feed.title}}</v-list-item-title>
              <v-list-item-subtitle>by {{feed.owner}}</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
