<template>
  <div>
    <br />
    <a-row>
      <a-col :xs="1" :sm="1" :md="6" :lg="6" :xl="8"></a-col>
      <a-col :xs="22" :sm="22" :md="12" :lg="12" :xl="8" style="font-family: 'Roboto', sans-serif;">
        <div class="activePeople">
          ...
          <div v-for="(user,index) in loadUser[0]" :key="index">
            <md-avatar class="md-avatar-icon md-primary md-large" style="border: 2px solid grey">
        ...
        <div v-for="(meetup,index) in loadMeetUps" v-bind:key="index">
          <md-card class="md-elevation-3">
            <md-card-header>
              <md-avatar>
                <img v-if="meetup.profileUrl" :src="meetup.profileUrl" alt="">
                <img v-else
            ...
            <md-card-content>
              {{meetup.description | truncate(100)}}
            </md-card-content>
